...
connection.connect()
connection.request('POST', '/1/schemas/CurrencyRatio', json.dumps({
     "className":"CurrencyRatio","fields":{"currencySrc":{"type":"String"}, "currencyTo":{"type":"String"}, "ratio":{"type":"Number"} }
     }), {
